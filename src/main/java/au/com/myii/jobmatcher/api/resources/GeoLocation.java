...
// There's probably a proper library that does this but using this for quickly getting something working.
...
public class GeoLocation {
	...
	/**
	 * Computes the distance between this GeoLocation instance and the location argument in km.
	 * @return the distance, measured in km.
	 */
	public double distanceToInKm(GeoLocation location) {
		return Math.acos(Math.sin(radLat) * Math.sin(location.radLat) +
				Math.cos(radLat) * Math.cos(location.radLat) *
